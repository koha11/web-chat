...
server.listen(PORT, () => {
    console.log(`Server running on ${ENVIRONMENT == "DEV" ? `http://${HOST}:${PORT}` : `https://${HOST}`}`);
    console.log(`GraphQL endpoint: ${ENVIRONMENT == "DEV"
        ? `http://${HOST}:${PORT}/graphql`
        : `https://${HOST}/graphql`}`);
    console.log(`GraphQL WS endpoint: ${ENVIRONMENT == "DEV"
        ? `ws://${HOST}:${PORT}/subscriptions`
        : `wss://${HOST}/subscriptions`}`);
    console.log(`RTC Signal WS endpoint: ${ENVIRONMENT == "DEV"
